...
verbose=1
CUDA_INSTALL_PATH ?= /global/scratch/software/cuda/cuda-3.2/
...
# Includes
INCLUDES  += -I. -I$(CUDA_INSTALL_PATH)/include -I$(CUDA_INSTALL_PATH)/C/common/inc/ -I$(COMMONDIR)/inc -I$(SHAREDDIR)/inc
...
ifneq ($(DARWIN),)
  ...
  ifeq "$(strip $(HP_64))" ""
    ifeq ($(x86_64),1)
       LIB       := -L$(CUDA_INSTALL_PATH)/lib64 -L$(LIBDIR) -L$(COMMONDIR)/lib/$(OSLOWER) -L$(SHAREDDIR)/lib -L$(CUDA_INSTALL_PATH)/lib
    else
...
ifneq ($(STATIC_LIB),)
	...
	ifneq ($(OMIT_CUTIL_LIB),1)
		LIB += -L/global/scratch/software/cuda/cuda-3.2/C/lib/ -lcutil_$(LIB_ARCH)$(LIBSUFFIX) -L/global/software/cuda/cuda-3.2/shared/lib -lshrutil_$(LIB_ARCH)$(LIBSUFFIX)
	endif
